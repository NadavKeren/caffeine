...
public final class BurstBlock {
    private final static boolean DEBUG = true;
    private final static Logger logger = System.getLogger(BurstBlock.class.getSimpleName());
    private final SearchableMinimumHeap<EntryData> heap;
    ...
    @Nullable public EntryData get(long key) {
        return heap.get(key);
    }
